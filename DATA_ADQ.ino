...
const char* mqtt_server = "192.168.1.105";     // Broker remoto MQTT ("broker.emqx.io")
...
void setup_devices(){
  ...
  rtc.adjust(DateTime(F(__DATE__), F(__TIME__)));   // Ajuste de fecha y hora reloj RTC
